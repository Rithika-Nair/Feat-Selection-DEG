# result_df_5$Quantile <- "5"
# result_df_10$Quantile <- "10"
# result_df_20$Quantile <- "20"
# result_df_25$Quantile <- "25"
# 
# combined_result_df_blca <- bind_rows(result_df_5, result_df_10, result_df_20, result_df_25)
# 
# head(combined_result_df_blca)
# 
# write.csv(combined_result_df_blca, file = "combined_result_method_1_blca.csv")

combined_result_df_blca <- read.csv("~/plots-final/combined_result_method_1_blca.csv")
...
plot_1_blca <-
  ...
  theme(legend.position = "none", 
        strip.text = element_text(size = 12)) +  # Increase facet header size
...
ggsave("blca_plot_1.png", width = 12, height = 10, dpi = 300)
...
ggsave("blca_plot_2.png", width = 12, height = 8, dpi = 300)
